...
Gem::Specification.new do |spec|
  ...
  spec.files = ["bin/jruby-enginize", "lib/generator.rb", "lib/script.rb", "templates/sinatra/views/stylesheet.sass", "templates/sinatra/views/layout.haml", "templates/sinatra/views/index.haml", "templates/sinatra/public/images/sinatra_logo.png", "templates/sinatra/lib/tasks/sinatra.rake", "templates/sinatra/config.ru", "templates/sinatra/config/warble.rb", "templates/sinatra/app.rb", "templates/shared/README", "templates/shared/Rakefile", "templates/shared/public/images/appengine_logo.png", "templates/shared/lib/jruby-rack-0.9.4.jar", "templates/shared/appengine-web.xml", "README.rdoc"]
  spec.require_path = "."
  spec.has_rdoc = true
